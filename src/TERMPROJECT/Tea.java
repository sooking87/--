...
public class Tea extends BottomButtons {
    ...
    public Tea(ListPanel li, Order or) {
        this.li = li;
        this.or = or;
        ...
        imagesPanel2.setLayout(new GridLayout(2, 4, 0, 30));
        ...
        for (int i = 0; i < 21; i++) {
            ...
            // 이벤트 리스너 등록
            menuImages[i].addMouseListener(new ClickedImage(or, li, "tea", fileName[i], imagesLabel[i], costLabel[i]));
